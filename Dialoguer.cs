...
public class Dialoguer
{
	...
	public static void Initialize(string key)
	{
		...
		DialoguerDataManager.Initialize(key);
	...
	public static void Initialize(DialogueType type = DialogueType.Origin)
	{
		switch (type)
		{
		case DialogueType.Origin:
			Initialize("dialoguer_data_object");
			break;
		case DialogueType.Scenario:
			Initialize("scenario_dialoguer_data_object");
			break;
		case DialogueType.Event:
			Initialize("event_dialoguer_data_object");
			break;
		case DialogueType.Infinity:
			Initialize("infinity_scenario");
			break;
		}
	}
	...
	{
		DialoguerDialogueManager.startDialogue(name);
	}
