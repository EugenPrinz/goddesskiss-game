...
namespace DialoguerCore
{
	public class DialoguerData
	{
		...
		public readonly Dictionary<string, DialoguerDialogue> dicDialogues;
		...
		public DialoguerData(DialoguerGlobalVariables globalVariables, List<DialoguerDialogue> dialogues, List<DialoguerTheme> themes)
		{
			...
			this.themes = themes;
			dicDialogues = new Dictionary<string, DialoguerDialogue>();
			dialogues.ForEach(delegate(DialoguerDialogue x)
			{
				dicDialogues.Add(x.name, x);
			});
		}
