namespace DialoguerCore
{
	public class DialoguerEventManager
	{
		...
		public static void dispatchOnMessageEvent(string message, string metadata, float duration, float r, float g, float b, float a)
		{
			if (DialoguerEventManager.onMessageEvent != null)
			{
				DialoguerEventManager.onMessageEvent(message, metadata, duration, r, g, b, a);
			}
		}
	}
}
