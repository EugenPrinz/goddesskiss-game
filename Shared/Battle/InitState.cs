...
namespace Shared.Battle
{
	...
	public class InitState
	{
		...
		public static InitState Create(EBattleType battleType, List<Troop> lhsTroops, List<Troop> rhsTroops, List<string> battleItemDrks, int randomSeed)
		{
			...
			initState._battleType = (int)battleType;
			initState._lhsTroops = lhsTroops;
			initState._rhsTroops = rhsTroops;
			initState._rhsTroopsHealth = 0L;
			initState._rhsTroopsMaxHealth = 0L;
			initState._randomSeed = randomSeed;
			initState._battleItemDrks = battleItemDrks;
			initState._stageId = string.Empty;
			return initState;
		}
