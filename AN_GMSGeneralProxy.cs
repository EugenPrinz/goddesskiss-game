...
public class AN_GMSGeneralProxy : MonoBehaviour
{
	...
	{
		AN_ProxyPool.CallStatic("com.androidnative.gms.core.GameClientBridge", methodName, args);
	}

	private static ReturnType CallActivityFunction<ReturnType>(string methodName, params object[] args)
	{
		return AN_ProxyPool.CallStatic<ReturnType>("com.androidnative.gms.core.GameClientBridge", methodName, args);
	}

	public static GP_PlayServicesStatus GetPlayServicesStatus()
	{
		return (GP_PlayServicesStatus)CallActivityFunction<int>("GetPlayServicesStatus", new object[0]);
	}
