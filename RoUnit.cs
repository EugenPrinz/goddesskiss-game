...
public class RoUnit
{
	...
	{
		return Create(id, (int)level + 1, 1, cls, costume, commanderId, favorRewardStep, marry, transcendence);
	}

	public RoUnit CreateNextGrade()
	{
		return Create(id, level, (int)rank + 1, cls, costume, commanderId, favorRewardStep, marry, transcendence);
	}
