...
public class GameCenter_TBM : ISN_Singleton<GameCenter_TBM>
{
	...
	public Dictionary<string, GK_TBM_Match> Matches => _Matches;
	...
	public void OnLoadMatchesResult(string data)
	{
		...
		GK_TBM_LoadMatchesResult gK_TBM_LoadMatchesResult = new GK_TBM_LoadMatchesResult(IsResultSucceeded: true);
