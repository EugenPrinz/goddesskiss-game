	...
	public abstract class ECCurve
	{
		...
		public virtual void SetPreCompInfo(ECPoint point, string name, PreCompInfo preCompInfo)
		{
			...
			lock (point)
			{
				...
				if (dictionary == null)
				{
					dictionary = (point.m_preCompTable = Org.BouncyCastle.Utilities.Platform.CreateHashtable(4));
				}
		...
		public virtual bool Equals(ECCurve other)
		{
			...
			return Field.Equals(other.Field) && A.ToBigInteger().Equals(other.A.ToBigInteger()) && B.ToBigInteger().Equals(other.B.ToBigInteger());
		}
