...
namespace Org.BouncyCastle.Crypto.EC
{
	public sealed class CustomNamedCurves
	{
		...
		{
			nameToCurve = Org.BouncyCastle.Utilities.Platform.CreateHashtable();
			nameToOid = Org.BouncyCastle.Utilities.Platform.CreateHashtable();
			oidToCurve = Org.BouncyCastle.Utilities.Platform.CreateHashtable();
			oidToName = Org.BouncyCastle.Utilities.Platform.CreateHashtable();
			names = Org.BouncyCastle.Utilities.Platform.CreateArrayList();
		...
		{
			names.Add(name);
			name = Org.BouncyCastle.Utilities.Platform.ToLowerInvariant(name);
		...
		{
			return ((X9ECParametersHolder)nameToCurve[Org.BouncyCastle.Utilities.Platform.ToLowerInvariant(name)])?.Parameters;
		}
		...
		{
			return (DerObjectIdentifier)nameToOid[Org.BouncyCastle.Utilities.Platform.ToLowerInvariant(name)];
		}
