...
namespace Org.BouncyCastle.Crypto.Engines
{
	public class Gost28147Engine : IBlockCipher
	{
		...
		static Gost28147Engine()
		{
			...
			sBoxes = Org.BouncyCastle.Utilities.Platform.CreateHashtable();
		...
		{
			byte[] array = (byte[])sBoxes[Org.BouncyCastle.Utilities.Platform.ToUpperInvariant(sBoxName)];
			if (array == null)
			{
