...
public class SPFacebook : SA_Singleton<SPFacebook>
{
	...
	private bool IsLoginRequestInProgress;
	...
	public static event Action<FB_PermissionResult> OnPermissionsLoaded;

	public static event Action<FB_Result> OnRevokePermission;
	...
	public void Login(params string[] scopes)
	{
		...
		if (!IsLoginRequestInProgress && !IsLoggedIn)
		{
	...
	static SPFacebook()
	{
		...
		SPFacebook.OnPermissionsLoaded = delegate
		{
		};
		SPFacebook.OnRevokePermission = delegate
		{
		};
