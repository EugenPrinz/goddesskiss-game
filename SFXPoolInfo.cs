...
public class SFXPoolInfo
{
	...
	public SFXPoolInfo(int index, int minAmount, List<float> times, List<GameObject> pool, float baseVol = 1f, float volVar = 0f, float pitchVar = 0f, bool pitchFix = false)
	{
