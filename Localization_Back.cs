...
public static class Localization_Back
{
	...
	public static Dictionary<string, string[]> dictionary
	{
		get
		{
			...
			{
				LoadDictionary(PlayerPrefs.GetString("Language", "Korean"));
			}
			return mDictionary;
		}
		set
	...
	public static string language
	{
		get
		{
			...
			{
				mLanguage = PlayerPrefs.GetString("Language", "Korean");
	...
	public static bool Exists(string key)
	{
		if (!localizationHasBeenSet)
		{
			language = PlayerPrefs.GetString("Language", "Korean");
		}
		string key2 = key + " Mobile";
