...
public class SoundPocket : MonoBehaviour
{
	...
	public void ConverterSfxPocket()
	{
		SoundPocketSfx soundPocketSfx = base.gameObject.GetComponent<SoundPocketSfx>();
		if (soundPocketSfx == null)
		{
			soundPocketSfx = base.gameObject.AddComponent<SoundPocketSfx>();
		}
		soundPocketSfx.Set(this);
