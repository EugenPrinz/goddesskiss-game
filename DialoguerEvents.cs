public class DialoguerEvents
{
	...
	public delegate void MessageEventHandler(string message, string metadata, float duration, float r, float g, float b, float a);
	...
	public void handler_MessageEvent(string message, string metadata, float duration, float r, float g, float b, float a)
	{
		if (this.onMessageEvent != null)
		{
			this.onMessageEvent(message, metadata, duration, r, g, b, a);
		}
	}
}
