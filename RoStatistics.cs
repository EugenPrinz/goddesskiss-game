...
public class RoStatistics
{
	...
	public int vipShopResetTime
	{
		...
		set
		{
			...
			vipShopResetTime_Data.SetByDuration(value);
		}
	}
	...
	public int perfectDailyMission => _CheckPerfectClear(EReward.DailyMission, "perfectDailyMission");

	public int perfectWeeklyMission => _CheckPerfectClear(EReward.WeeklyMission, "perfectWeeklyMission");

	public int perfectMonthlyMission => _CheckPerfectClear(EReward.MonthlyMission, "perfectMonthlyMission");
	...
	public int GetValue(string target)
	{
		...
		if (target.Contains("."))
		{
			...
			return propertyValue[array[1]];
		}
		return Utility.GetPropertyValue<int>(this, target, null);
	}
}
